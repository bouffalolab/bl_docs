...
\\fancyfoot[L]{\color{black} \\fontsize{9}{9} \selectfont BL602在线编程(ISP)协议}
...
\\fancypagestyle{plain}{
	\\fancyfoot[L]{\color{black} BL602在线编程(ISP)协议}
	\\fancyhead{}
}

\\fancyhead[R]{\makebox[165pt][r]{\\fontsize{15}{15} \selectfont BL602在线编程(ISP)协议}\\vspace{1pt}\hrule height 0pt \\vspace{10pt}}
