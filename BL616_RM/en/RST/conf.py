...
project = 'BL616/BL618 Reference Manual'
copyright = '2021'
author = 'bouffalolab'
...
\\usepackage{LastPage}
\\usepackage{titletoc}
\\titlecontents{chapter}[3.5em]{ \zihao{5}\\vspace{0pt} }{\contentslabel{2em}}{\hspace*{-2em}}{~\\titlerule*[0.8pc]{$.$}~\contentspage}

\\titlecontents{section}[6em]{ \zihao{5}\\vspace{0pt} }{\contentslabel{2.8em}}{\hspace*{-2em}}{~\\titlerule*[0.8pc]{$.$}~\contentspage}

\\titlecontents{subsection}[9em]{\zihao{5}\\vspace{0pt}}{\contentslabel{4em}}{\hspace*{-2em}}{~\\titlerule*[0.8pc]{$.$}~\contentspage}

\\titlecontents{subsubsection}[11.5em]{\zihao{5}\\vspace{0pt}}{\contentslabel{5em}}{\hspace*{-2em}}{~\\titlerule*[0.8pc]{$.$}~\contentspage}
...
{\\raggedright\zihao{-4}\heiti\color{MidnightBlue}}
{\\thesubsubsection }
{6pt}
{}
...
\\fancyfoot[L]{\color{black} \\fontsize{9}{9} \selectfont BL616/BL618 Reference Manual}
\\fancyfoot[C]{\color{black} \\fontsize{9}{9} \selectfont \\thepage / \pageref{LastPage}}
\\fancyfoot[R]{\color{black} \\fontsize{9}{9} \selectfont @2022 {\href{http://www.bouffalolab.com/}{\color{black} Bouffalo Lab}}}
%\cfoot{\\thepage}
\\fancypagestyle{plain}{
	\\fancyfoot[L]{\color{black} BL616/BL618 Reference Manual}
	\\fancyhead{}
}

\\fancyhead[R]{\makebox[165pt][r]{\\fontsize{15}{15} \selectfont BL616/BL618 Reference Manual}\\vspace{1pt}\hrule height 0pt \\vspace{10pt}}
...
\\newcommand\\regover[1]
{
	\\begin{center}
		\\begin{longtable}[H]{|p{140pt}|p{350pt}|}
			\hline\hline
			\\rowcolor{tbcol}
			\\begin{minipage}{1.5cm}\\vspace{0.2cm}{\\bfseries Name}\\vspace{0.2cm}\end{minipage}&\\bfseries Description \\\\
...
\\newcommand\\regdes[1]
{
	\\begin{center}
		...
		\\begin{longtable}[c]{|p{30pt}<{\centering}|p{128pt}<{\centering}|p{20pt}<{\centering}|p{40pt}<{\centering}|p{233pt}|}
			\hline\hline
			\\rowcolor{tbcol}
			\\begin{minipage}{1.5cm}\\vspace{0.2cm}{\\bfseries \centering {Bits}}\\vspace{0.2cm}\end{minipage}&\\bfseries \centering Name&\\bfseries \centering Type &\\bfseries Reset&{\\bfseries \centering Description} \\\\
