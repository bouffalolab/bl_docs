...
| 名称                 | 描述                               |
+----------------------+------------------------------------+
| `i2c_config`_        | Master configure                   |
+----------------------+------------------------------------+
| `i2c_int_sts`_       | Interrupt configure and status     |
+----------------------+------------------------------------+
| `i2c_sub_addr`_      | Sub-address setting                |
+----------------------+------------------------------------+
| `i2c_bus_busy`_      | Bus busy status                    |
+----------------------+------------------------------------+
| `i2c_prd_start`_     | Start period setting               |
+----------------------+------------------------------------+
| `i2c_prd_stop`_      | Stop period setting                |
+----------------------+------------------------------------+
| `i2c_prd_data`_      | Data period setting                |
+----------------------+------------------------------------+
| `i2c_fifo_config_0`_ | FIFO status and DMA mode           |
+----------------------+------------------------------------+
| `i2c_fifo_config_1`_ | FIFO threshold and available count |
+----------------------+------------------------------------+
| `i2c_fifo_wdata`_    | TX FIFO                            |
+----------------------+------------------------------------+
| `i2c_fifo_rdata`_    | RX FIFO                            |
+----------------------+------------------------------------+
...
.. table::
    ...
    +----------+------------------------------+--------+-------------+-------------------------------------------------------------------------------------------------------------------+
    | 15:8     | cr_i2c_prd_d_ph_1            | r/w    | 8'd15       | Length of DATA phase 1 (unit: I2C source clock period)                                                            |
    +          +                              +        +             +                                                                                                                   +
