...
\\fancyfoot[L]{\color{black} \\fontsize{9}{9} \selectfont BL808 数据手册}
...
\\fancypagestyle{plain}{
	\\fancyfoot[L]{\color{black} BL808 数据手册}

	\\fancyhead{}
}

\\fancyhead[R]{\makebox[165pt][r]{\\fontsize{15}{15} \selectfont BL808 数据手册}\\vspace{1pt}\hrule height 0pt \\vspace{10pt}}
