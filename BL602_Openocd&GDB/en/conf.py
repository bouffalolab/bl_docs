...
project = 'Introduction of OpenOCD and GDB'
...
\\fancyfoot[L]{\color{black} \\fontsize{9}{9} \selectfont Introduction to Openocd and GDB}
...
\\fancypagestyle{plain}{
	\\fancyfoot[L]{\color{black} Introduction to Openocd and GDB}
	\\fancyhead{}
}

\\fancyhead[R]{\makebox[165pt][r]{\\fontsize{15}{15} \selectfont Introduction to Openocd and GDB}\\vspace{1pt}\hrule height 0pt \\vspace{10pt}}
