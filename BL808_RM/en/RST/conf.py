...
project = 'BL808 Reference Manual'
copyright = '2021'
author = 'bouffalolab'
...
\\usepackage{LastPage}
\\usepackage{titletoc}
\\titlecontents{chapter}[3.5em]{ \zihao{5}\\vspace{0pt} }{\contentslabel{1.3em}}{\hspace*{-2em}}{~\\titlerule*[0.8pc]{$.$}~\contentspage}
...
\\titlecontents{subsubsection}[10em]{\zihao{5}\\vspace{0pt}}{\contentslabel{5em}}{\hspace*{-2em}}{~\\titlerule*[0.8pc]{$.$}~\contentspage}
...
\\fancyfoot[L]{\color{black} \\fontsize{9}{9} \selectfont BL808 Reference Manual}
...
\\fancypagestyle{plain}{
	\\fancyfoot[L]{\color{black} BL808 Reference Manual}
	\\fancyhead{}
}

\\fancyhead[R]{\makebox[165pt][r]{\\fontsize{15}{15} \selectfont BL808 Reference Manual}\\vspace{1pt}\hrule height 0pt \\vspace{10pt}}
