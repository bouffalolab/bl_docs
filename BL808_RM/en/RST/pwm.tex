...
\\
\hline
{\hyperref[pwm-pwm-mc1-config0]{pwm\_mc1\_config0}}&
\\
\hline
{\hyperref[pwm-pwm-mc1-config1]{pwm\_mc1\_config1}}&
\\
\hline
{\hyperref[pwm-pwm-mc1-period]{pwm\_mc1\_period}}&
\\
\hline
{\hyperref[pwm-pwm-mc1-dead-time]{pwm\_mc1\_dead\_time}}&
\\
\hline
{\hyperref[pwm-pwm-mc1-ch0-thre]{pwm\_mc1\_ch0\_thre}}&
\\
\hline
{\hyperref[pwm-pwm-mc1-ch1-thre]{pwm\_mc1\_ch1\_thre}}&
\\
\hline
{\hyperref[pwm-pwm-mc1-ch2-thre]{pwm\_mc1\_ch2\_thre}}&
\\
\hline
{\hyperref[pwm-pwm-mc1-ch3-thre]{pwm\_mc1\_ch3\_thre}}&
\\
\hline
{\hyperref[pwm-pwm-mc1-int-sts]{pwm\_mc1\_int\_sts}}&
\\
\hline
{\hyperref[pwm-pwm-mc1-int-mask]{pwm\_mc1\_int\_mask}}&
\\
\hline
{\hyperref[pwm-pwm-mc1-int-clear]{pwm\_mc1\_int\_clear}}&
\\
\hline
{\hyperref[pwm-pwm-mc1-int-en]{pwm\_mc1\_int\_en}}&
\\
\hline
}
...
9&pwm1\_int\_clr&w1c&1'b0&PWM 1 interrupt clear (clear pwm\_mc1\_int\_sts[10:0] all)\\\hline
8&pwm0\_int\_clr&w1c&1'b0&PWM 0 interrupt clear (clear pwm\_mc0\_int\_sts[10:0] all)\\\hline
7:2&RSVD& & & \\\hline
1&pwm1\_int\_sts&r&1'b0&PWM 1 interrupt status (Check pwm\_mc1\_int\_sts for detailed interrupt status)\\\hline
...
\subsection{pwm\_mc1\_config0}
\label{pwm-pwm-mc1-config0}
Address：0x2000a480
 \begin{figure}[H]
\includegraphics{pwm_pwm_mc1_config0.pdf}
\end{figure}
...
\subsection{pwm\_mc1\_config1}
\label{pwm-pwm-mc1-config1}
Address：0x2000a484
 \begin{figure}[H]
\includegraphics{pwm_pwm_mc1_config1.pdf}
\end{figure}
...
Address：0x2000a488
 \begin{figure}[H]
\includegraphics{pwm_pwm_mc1_period.pdf}
\end{figure}
...
Address：0x2000a48c
 \begin{figure}[H]
\includegraphics{pwm_pwm_mc1_dead_time.pdf}
\end{figure}
...
\subsection{pwm\_mc1\_ch0\_thre}
\label{pwm-pwm-mc1-ch0-thre}
Address：0x2000a490
 \begin{figure}[H]
\includegraphics{pwm_pwm_mc1_ch0_thre.pdf}
\end{figure}
...
\subsection{pwm\_mc1\_ch1\_thre}
\label{pwm-pwm-mc1-ch1-thre}
Address：0x2000a494
 \begin{figure}[H]
\includegraphics{pwm_pwm_mc1_ch1_thre.pdf}
\end{figure}
...
\subsection{pwm\_mc1\_ch2\_thre}
\label{pwm-pwm-mc1-ch2-thre}
Address：0x2000a498
 \begin{figure}[H]
\includegraphics{pwm_pwm_mc1_ch2_thre.pdf}
\end{figure}
...
\subsection{pwm\_mc1\_ch3\_thre}
\label{pwm-pwm-mc1-ch3-thre}
Address：0x2000a49c
 \begin{figure}[H]
\includegraphics{pwm_pwm_mc1_ch3_thre.pdf}
\end{figure}
...
\subsection{pwm\_mc1\_int\_sts}
\label{pwm-pwm-mc1-int-sts}
Address：0x2000a4a0
 \begin{figure}[H]
\includegraphics{pwm_pwm_mc1_int_sts.pdf}
\end{figure}
...
\subsection{pwm\_mc1\_int\_mask}
\label{pwm-pwm-mc1-int-mask}
Address：0x2000a4a4
 \begin{figure}[H]
\includegraphics{pwm_pwm_mc1_int_mask.pdf}
\end{figure}
...
\subsection{pwm\_mc1\_int\_clear}
\label{pwm-pwm-mc1-int-clear}
Address：0x2000a4a8
 \begin{figure}[H]
\includegraphics{pwm_pwm_mc1_int_clear.pdf}
\end{figure}
...
\subsection{pwm\_mc1\_int\_en}
\label{pwm-pwm-mc1-int-en}
Address：0x2000a4ac
 \begin{figure}[H]
\includegraphics{pwm_pwm_mc1_int_en.pdf}
\end{figure}
