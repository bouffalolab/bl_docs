...
\\titlecontents{subsubsection}[11em]{\zihao{5}\\vspace{0pt}}{\contentslabel{5em}}{\hspace*{-2em}}{~\\titlerule*[0.8pc]{$.$}~\contentspage}
...
\\fancyfoot[L]{\color{black} \\fontsize{9}{9} \selectfont BL808 参考手册}
...
\\fancypagestyle{plain}{
	\\fancyfoot[L]{\color{black} BL808 参考手册}
	\\fancyhead{}
}

\\fancyhead[R]{\makebox[165pt][r]{\\fontsize{15}{15} \selectfont BL808 参考手册}\\vspace{1pt}\hrule height 0pt \\vspace{10pt}}
...
\\newcommand\\regdes[1]
{
		...
		\\begin{longtable}[l]{|p{25pt}<{\centering}|p{128pt}<{\centering}|p{20pt}<{\centering}|p{40pt}<{\centering}|p{180pt}|}
			\hline\hline
			\\rowcolor{tbcol}
